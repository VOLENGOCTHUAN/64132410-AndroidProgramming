                ...
                int id = item.getItemId();
                 if (id == R.id.menu_about) {
                    ...
                    return true;
                     ...
                     // Lấy dữ liệu từ intent nhận được từ LoginActivity
                     Intent getLogin = getIntent();
                     String email = getLogin.getStringExtra("email");
                     // Tạo intent mới và truyền dữ liệu sang UserInfoActivity
                     Intent intent = new Intent(Man_hinh_chinh.this, UserInfoActivity.class);
                     ...
                     System.exit(0);   // Kết thúc process
                     return true;
                 }
                return false;
            }
