...
public class TuDoLuyenTapActivity extends AppCompatActivity {
    ...
    private void loadQuestions(int chapter) {
        ...
        if (chapter==1) {
            questionList.add(new Question_Quiz("15 + 17 = ?", "32", "33",
                    "31", "30", "32"));
            questionList.add(new Question_Quiz("50 - 25 = ?", "25", "24",
                    "26", "23", "25"));
            questionList.add(new Question_Quiz("8 x 3 = ?", "24", "23",
                    "25", "22", "24"));
            questionList.add(new Question_Quiz("36 ÷ 6 = ?", "6", "5",
                    "7", "8", "6"));
